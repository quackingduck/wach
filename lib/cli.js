(function() {
  var logInfo, minimatch, parseArgs, passesGlobFilters, path, spawn, substitutePath, termColor, termColorWrap, usage, watch;
  path = require('path');
  ...
  logInfo = function(msg) {
    return console.log(termColorWrap('0;38;5;246', "- " + msg));
  };
